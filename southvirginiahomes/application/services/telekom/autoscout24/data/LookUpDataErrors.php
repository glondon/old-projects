 ...
 * @subpackage data
 */
class LookUpDataErrors {
	
	/**
	 * Constructs the data object with the specified values.
	 *
	 * Invocation of the constructor without parameters is possible.
	 * @param array[int]LookUpDataErrorsError $error An array of data type error.
	 */
	 ...
	 * @return array[int]LookUpDataErrorsError
	 ...
	 * @param array[int]LookUpDataErrorsError $error

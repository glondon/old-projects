 ...
 * @subpackage data
 */
class MakeModelTreeErrors {
	
	/**
	 * Constructs the data object with the specified values.
	 *
	 * Invocation of the constructor without parameters is possible.
	 * @param array[int]MakeModelTreeErrorsError $error An array of data type error.
	 */
	 ...
	 * @return array[int]MakeModelTreeErrorsError
	 ...
	 * @param array[int]MakeModelTreeErrorsError $error

...
class LookUpData {
	 ...
	 * @param LookUpDataErrors $errors The error code and message, see error.
	 * @param LookUpDataBuild $build Build information container

...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-bottom: 0;">
		<tr>
				<td class="topic-crap"><img src="', $settings['images_url'], '/topic/', $context['class'], '.gif" align="bottom" alt="" /></td>
				<td class="brkdmrcnorta" valign="middle" width="5%" style="padding-left: 6px;"> ', $txt[29], '</td>
				<td class="brkdmrcnorta" width="10%"> </td>
				<td class="brkdmrcnorta" valign="middle" width="85%" style="padding-left: 6px;" id="top_subject">
						', $txt[118], ': <h1>', $context['subject'], '</h1> &nbsp;(', $txt[641], ' ', $context['num_views'], ' ', $txt[642], ')
				</td>
				<td><img src="', $settings['images_url'], '/brkdmrcnsag.gif" border="0" alt="" /></td>
		</tr>';
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	<tr><td style="padding: 1px 1px 0 1px;">';
		...
		if (!$message['member']['is_guest'])
		{
            ...
            echo '
                        <b>', $message['member']['location'], '</b><br />';
            // End modification 											
		...
		if ($message['id'] == $context['first_message'])
			echo '
		<p align="center" style="padding-bottom:15px;"><a href="http://hits4pay.com/members/index.cgi?gdc25" target="_blank"><img border="0" src="http://hits4pay.com/imgn/banners/468x60.png" width="468" height="60"></a></p>';
		...
		elseif ($context['user']['is_guest'])
			echo '
			<a href="http://www.signupandmakemoney.com/forum/register/">Register</a> or <a href="http://www.signupandmakemoney.com/forum/login/">login</a> to reply ';							
		echo '

...
function template_main()
{
	...
	echo '<p align="center" style="padding-top:10px;padding-bottom:20px;"><script type="text/javascript">
...
document.write(mbannerads[mchoosead])					
	...
	{
		echo '
		<table width="100%" cellpadding="6" cellspacing="1" border="0" style="padding: 0; margin-bottom: 2ex;">
			<tr>

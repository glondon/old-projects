...
function template_main()
{
	...
	{
		echo '
	<br /><div style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">';
		$first = false;

echo '<table style=" width: 100%; height: 28px;" border="0" cellpadding="0" cellspacing="0">
<tr>
<td class="brkdmrcnsol">&nbsp;</td><td class="brkdmrcnorta"><h2>', $category['name'], '</h2></td><td class="brkdmrcnsag">&nbsp;</td>
</tr>
</table>';
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor">
			<tr>
				...
				<td class="titlebg" align="center">' , $txt[22] , '</td>
				<td class="titlebg" align="center">' , $txt[64] , '</td>
				<td class="titlebg" align="center">' , $txt[21] , '</td>
				<td class="titlebg" align="center">' , $txt[298] , '</td>
			</tr>';
			...
			<tr>';
				...
				if (!empty($board['last_post']['id']))
					...
					<span class="smalltext">
						<img align="left" style="padding-right:3px" src="', $settings['images_url'], '/post/xx.gif" alt="" />
						<font style="font-size:8pt">', $txt['smf88'], ' <b>', $board['last_post']['link'], '</b></font><br />
						<b>', $txt[525], '</b> ', $board['last_post']['member']['link'] , '<br />                                            
						<span style="float: right;">', $txt[30], ' ', $board['last_post']['time'], '<a href="', $board['last_post']['href'], '">	
						<img src="', $settings['images_url'], '/last_post.gif"  border="0" alt="" /></a></span>
					</span>';
					echo '
				</td>
...
<td class="windowbg2" valign="middle" align="center" width="12%">';
					echo '
...
echo '<table style=" width: 100%; height: 28px;" border="0" cellpadding="0" cellspacing="0">
<tr>
<td class="brkdmrcnaltsol">&nbsp;</td><td class="brkdmrcnaltorta">&nbsp;</td><td class="brkdmrcnaltsag">&nbsp;</td>
</tr>
</table>';
	}
	echo '<p align="center" style="padding-top:20px;padding-bottom:15px;"><SCRIPT LANGUAGE="JavaScript1.1" SRC="http://bdv.bidvertiser.com/BidVertiser.dbm?pid=118577&bid=1364207" type="text/javascript"></SCRIPT><noscript><a href="http://www.bidvertiser.com">pay per click</a></noscript></p>';
...
<tr>
<td class="brkdmrcnsol">&nbsp;</td><td class="brkdmrcnorta" align="center"><h2>', $txt[685], '</h2></td><td class="brkdmrcnsag">&nbsp;</td>
</tr>
</table>
		</div>
	...
	<tr>
		...
		<td class="windowbg2" width="100%">
			<table border="0" width="90%"><tr>
				...
				<td width="32%" class="middletext" valign="top">
